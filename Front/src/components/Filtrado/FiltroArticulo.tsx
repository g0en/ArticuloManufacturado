...
const FiltroProductos: React.FC<FiltroProductosProps> = ({ categorias, unidadesMedida, handleChangeText, handleChangeCategoria, handleChangeUnidadMedida }) => {
    return (
        <Row>
            ...
            <Col>
                <select className="form-select" name="filtro_categoria" id="filtro_categoria" onChange={(e: React.ChangeEvent<HTMLSelectElement>) => handleChangeCategoria(Number(e.target.value))}>
            ...
            <Col>
                <select className="form-select" name="filtro_unidad-medida" id="filtro_unidad-medida" onChange={(e: React.ChangeEvent<HTMLSelectElement>) => handleChangeUnidadMedida(Number(e.target.value))}>
                    <option value="-1">Todos</option>
